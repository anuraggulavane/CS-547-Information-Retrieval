...
MY_ANUM  = 901019306 # put your UID here
...
class BetterIndex(object):
    ...
    def wildcard_search_or(self, text):
        # FILL OUT CODE HERE
        terms = self.tokenize(text, is_search=True)
        result_set = set()
        for term in terms:
            term = self._rotate(term)
            result_set = result_set.union(crawl_tree(self._bt.root, term))
        final_list = [self._documents[idx] for idx in result_set]
        return final_list
    ...
    def wildcard_search_and(self, text):
        # FILL OUT CODE HERE
        terms_original = self.tokenize(text, is_search=True)
        terms = []
        for term in terms_original:
            terms.append(self._rotate(term))
        result_set = set(crawl_tree(self._bt.root, terms[0]))
        if len(terms) > 1:
            for term in terms[1:]:
                result_set = result_set.intersection(crawl_tree(self._bt.root, term))
        final_list = [self._documents[idx] for idx in result_set]
        return final_list
...
# Commit 45 on 2024-08-22T18:01:31
# Commit 69 on 2024-08-22T18:12:12
# Commit 8 on 2024-08-22T23:52:53
# Commit 25 on 2024-08-22T17:12:49
# Commit 31 on 2024-08-22T16:43:57
# Commit 38 on 2024-08-22T21:19:24
# Commit 43 on 2024-08-22T16:58:44
# Commit 51 on 2024-08-22T15:20:34
# Commit 60 on 2024-08-22T22:31:00
# Commit 9 on 2024-12-07T23:55:40
# Commit 39 on 2024-11-10T07:11:17
# Commit 42 on 2024-09-13T06:12:31
# Commit 46 on 2024-12-14T06:20:09
# Commit 50 on 2024-09-05T20:31:31
# Commit 58 on 2024-11-06T22:27:31
